        ...
        <div class="assistencias">
            ...
            <section class="assistencias-row-section">
                <div class="assistencias-row-wrapper" style="position:relative;min-height:360px;">
                    <div class="assistencias-row" style="display:flex;gap:2rem;justify-content:space-between;flex-wrap:wrap;">
                        <div class="assistencia-card-item" style="flex:0 0 auto;max-width:auto;background:#fff;border-radius:14px;box-shadow:0 2px 8px rgba(0,0,0,0.06);padding:0;text-decoration:none;color:#222;display:flex;flex-direction:column;transition:box-shadow 0.2s,transform 0.2s;">
